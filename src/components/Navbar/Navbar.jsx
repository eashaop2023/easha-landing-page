    ...
    <nav className="navbar navbar-expand-lg bg-white mb-2 fixed-top">
      ...
      <div className="container-xl d-flex justify-content-between align-items-center w-100">
        ...
        <div className="mobile-breadcrumb-header d-lg-none">
          {" "}
          <button
            className="breadcrumb-toggler border-0 bg-transparent"
        ...
        <div
          className={`mobile-sidebar ${isSidebarOpen ? "sidebar-open" : ""} d-lg-none`}
        >
          {" "}
          <div className="sidebar-header border-bottom">
            {" "}
            <button
              className="border-0 bg-transparent fs-4 me-3"
          ...
          <div className="sidebar-links-container">
            ...
            {navLinks.map((link) => (
              <NavLink
                ...
                onClick={() => setSidebarOpen(false)}
                className={({ isActive }) =>
                  `text-decoration-none sidebar-link ${isActive ? "active-sidebar-nav" : ""}`
                }
              >
                {link.name}{" "}
              </NavLink>
        ...
        <div className="login-signup-container">
          ...
          <div className="signup-dropdown">
            ...
            <div className="signup-options">
              ...
              <a
                href="https://eashaop.com/"
                className="signup-option text-decoration-none"
              >
                Sign Up as User
              </a>{" "}
              <a
