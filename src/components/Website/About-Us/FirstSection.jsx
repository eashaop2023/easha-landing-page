...
//       {/* Replace your current About Us header with this */}
// <div className="w-full">
//   <div
//     className="w-full h-[160px] bg-[#1F4053] flex justify-center items-center pt-10 mt-[65px] lg:mt-0"
//   >
//     <h2 className="font-urbanist font-bold text-white text-3xl md:text-4xl lg:text-[41px] m-0">
//       About Us
//     </h2>
//   </div>
// </div>
...
//           appointments, teleconsultations, and doorstep medicine delivery. With
//           AI diagnostics, Aadhaar OTP, and DigiLocker integration, we connect
//           patients, pharmacies, and emergency services—all in one place.
//         </p>
//       </div>
//     </div>
//   );
